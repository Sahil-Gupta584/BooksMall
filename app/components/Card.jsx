...
export default function BookCard({ book, src }) {
  return (
    <div className="group relative m-0 w-full max-w-[320px] overflow-hidden rounded-xl border-2 border-orange-500 bg-white bg-opacity-20 backdrop-blur-lg backdrop-filter transition-all duration-300 hover:shadow-xl sm:w-[200px] md:w-[250px]">
